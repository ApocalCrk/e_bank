 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="stok" id="stok" placeholder="Stok" value="<?php echo $stok; ?>" min='1'/>
        </div>
        ...
        <div class="form-group">
            <label for="int">Harga Pokok/Awal<?php echo form_error('harga_pokok') ?></label>
            <input type="text" class="form-control" name="harga_pokok" id="harga_pokok" placeholder="Harga Pokok/Awal" value="<?php echo $harga_pokok; ?>" required/>
        </div>

        <div class="form-group">
            <label for="int">Harga Jual<?php echo form_error('harga_jual') ?></label>
            <input type="text" class="form-control" name="harga_jual" id="harga_jual" placeholder="Harga Jual" value="<?php echo $harga; ?>" />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="key_barang" id="id_own" placeholder="pemilik" value="<?php echo $this->session->userdata('nama'); ?>" readonly/>
        </div>
