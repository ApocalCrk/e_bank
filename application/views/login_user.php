                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    <div class="form-group">
                      <input type="username" name="username" class="form-control form-control-user" placeholder="Username" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="text" autocomplete="off" name="captcha_text" class="form-control form-control-user" placeholder="Enter Captcha" style="float: left;width: 47.5%" required>
                      ...
                      <input type="hidden" name="asw_asc4" value="<?php echo $encrypt; ?>" readonly>
                    </div>
                    <?php }else{?>
                      ...
                      base64_encode(ob_get_clean())); ?></div>
                        ...
                        <?php $encrypt = encrypt($captcha_code, $password); ?>
                        <input type="hidden" name="asw_asc4" value="<?php echo $encrypt ?>" class="form-control form-control-user" placeholder="Enter Captcha" style="float: left;width: 47.5%" readonly>
                      </div>
                    <?php } ?>
                    <!-- End Captcha -->
