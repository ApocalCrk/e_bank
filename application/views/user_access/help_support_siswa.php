...
<div class="col-md-4 container">
	...
	<a class="align-items-center box-mes" 
		...
		position: relative;
		text-decoration: none;
		color: inherit;" onclick="morePay()" 
		>
		<i class="rounded-circle fa fa-exchange-alt" style="font-size: 200%;margin-left: 20px;border: 1px solid #ccc;padding: 10px;box-shadow: 1px 1px 1px 0px #ccc"></i>
		<p style="position: relative;top:8px;left: 20px;width: 250px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
			Bantuan Pembayaran
		</p>
		<i class="fa fa-angle-down" style="font-size: 25px;margin-top: 2px;" id="rot_2"></i>
	</a>
	<style type="text/css">
		.prob_acc {
			width: 100%;
	...
	<div id="showMore_2" style="display: none;">
		<a href="" 
		style="width: 100%;height: 50px;background-color: #e8f0fe;display: inline-flex;position: relative;color: inherit;padding-top: 12px;padding-bottom: 12px;text-decoration: none;">
			<span class="prob_acc"><p style="margin-left: 12px">Pembelian</p></span>
		</a>
		<a href="" 
		style="width: 100%;height: 50px;background-color: #e8f0fe;display: inline-flex;position: relative;color: inherit;padding-top: 12px;padding-bottom: 12px;text-decoration: none;">
			<span class="prob_acc"><p style="margin-left: 12px">Histori Pembelian</p></span>
		</a>
		<a href="" 
		style="width: 100%;height: 50px;background-color: #e8f0fe;display: inline-flex;position: relative;color: inherit;padding-top: 12px;padding-bottom: 12px;text-decoration: none;">
			<span class="prob_acc"><p style="margin-left: 12px">Histori Pengeluaran</p></span>
		</a>
	</div>
	...
	<div id="showMore_3" style="display: none;margin-top: -5px">
		...
		style="width: 100%;height: 50px;background-color: #e8f0fe;display: inline-flex;position: relative;color: inherit;padding-top: 12px;padding-bottom: 12px;text-decoration: none;border-radius: 0 0 10px 10px">
			<span class="prob_acc"><p style="margin-left: 12px">Top-up</p></span>
		</a>
	</div>
