...
<form action="" method="POST">
	...
	<div class="row col">
		...
		?>
		<!-- <div class="ml-1">
			<a href="<?php echo site_url('kantinui/export_bulan_laba/'.$tanggal_ei) ?>" class="btn btn-info" id='ch'>Export</a>
			<a href="<?php echo site_url('kantinui/export_bulan_laba/'.$tanggal) ?>" class="btn btn-info" id='non-chrome'>Export</a>
		</div> -->
	</div>
</form>
...
<table class="table" id="dataTable">
	...
	<?php 
		...
		if($bulan != "" and $tahun != ""){
		$sql = $this->db->query("SELECT * FROM penjualan_header,barang,penjualan_detail where penjualan_header.key_barang='$kode' and penjualan_detail.kode_penjualan=penjualan_header.kode_penjualan and barang.kode_barang=penjualan_detail.kode_barang and MONTH(tgl_penjualan)='$bulan' and YEAR(tgl_penjualan)='$tahun'");
